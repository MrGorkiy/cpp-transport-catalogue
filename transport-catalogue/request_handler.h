...
/*
 * Я сначала начал реализовывать данный функционал, но потом отказался, так как отстаю на неделю по графику,
 * а дедлайн рядом((((( Поэтому отложил реализацию на следующие модули
 */
